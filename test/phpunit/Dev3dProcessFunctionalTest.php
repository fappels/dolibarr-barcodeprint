...
/**
 * \file    test/phpunit/BarcodePrintFunctionalTest.php
...
/**
 * Class BarcodePrintFunctionalTest
 *
 ...
 *
 * @package Testbarcodeprint
 */
class BarcodePrintFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modBarcodePrint')->click();
		} else {
			// Disable the module
			$this->byHref('modBarcodePrint')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/barcodeprint/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('barcodeprint/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/barcodeprint/admin/about.php');
		$this->authenticate();
		return $this->assertContains('barcodeprint/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('barcodeprintwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modBarcodePrint_BarcodePrintTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modBarcodePrint_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
